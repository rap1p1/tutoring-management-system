                    ...
                    <tbody>
                      {supportRequests.length === 0 ? (
                        ...
                        <tr key={s.maycdg}>
                          ...
                          <td style={{ maxWidth: '250px', whiteSpace: 'pre-wrap', wordBreak: 'break-word' }}>{s.lydo}</td>
                      ...
                      {absences.length === 0 ? (
                        ...
                        return (
                          <tr key={a.mabuoi}>
                            ...
                            <td style={{ maxWidth: '350px', whiteSpace: 'pre-wrap', wordBreak: 'break-word' }}>{a.noidung}</td>
                            <td>
